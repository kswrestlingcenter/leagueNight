...
const navigation = [
  ...
  { name: 'Wrestlers', href: '/wrestlers', current: false },
  { name: 'League Events', href: '/league-events', current: false },
]
